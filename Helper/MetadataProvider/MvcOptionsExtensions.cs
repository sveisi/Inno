...
namespace Inno.Helper.ConventionalMetadataProviders {
    public static class MvcOptionsExtensions {
        ...
        public static void SetConventionalMetadataProviders(this MvcOptions options, Type displayMetadataResourceType, Type validationResourceType = null, Type bindingResourceType = null) {
            ...
            if (validationResourceType == null) validationResourceType = typeof(Resources.ValidationMessages);
            if (bindingResourceType == null) bindingResourceType = typeof(Resources.BindingMessages);
