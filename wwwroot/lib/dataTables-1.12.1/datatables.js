 ...
 *   https://datatables.net/download/#bs5/dt-1.12.1/date-1.1.2/fh-3.2.4/r-2.3.0/sl-1.4.0
 *
 * Included libraries:
 *   DataTables 1.12.1, DateTime 1.1.2, FixedHeader 3.2.4, Responsive 2.3.0, Select 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.12.1/date-1.1.2/fh-3.2.4/r-2.3.0/sl-1.4.0",
