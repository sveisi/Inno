 ...
 *   https://datatables.net/download/#bs5/dt-2.3.7/date-1.6.3/fh-4.0.5/r-3.0.8/sl-3.1.3
 *
 * Included libraries:
 *   DataTables 2.3.7, DateTime 1.6.3, FixedHeader 4.0.5, Responsive 3.0.8, Select 3.1.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.3.7/date-1.6.3/fh-4.0.5/r-3.0.8/sl-3.1.3",
